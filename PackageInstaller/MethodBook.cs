namespace UnrealEnginePackageManager
{
    ...
    public class MethodBook
    {
        ...
        /// <summary>
        /// Extracts a specific file from a RAR archive.
        /// </summary>
        /// <param name="rarFilePath">The RAR archive file path.</param>
        /// <param name="destinationPath">The destination path where the file will be extracted.</param>
        /// <param name="fileName">The name of the file to extract from the archive.</param>
        ...
        /// <summary>
        /// Lists all files in a RAR or ZIP archive.
        /// </summary>
        /// <param name="archiveFilePath">The path to the RAR or ZIP archive.</param>
        /// <returns>A list of file names contained in the archive.</returns>
